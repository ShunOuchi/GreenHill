...
//
    ...
    struct GraphNode
    {
        ...
        GraphNode(): isHomo(false), state(0), length(0), numEdge(0), edge(), MPLinks(), HiCLinks(), numContig(0), contig(), numMappedTag(), oppositeBubbleNodeID(0) {} //edited by ouchi (MPLinks(), HiCLinks())
    ...
    struct GraphLayout
    {
        ...
        GraphLayout(): id(0), start(0), end(0), distance(0), numLink(0), h(0) {} //edited by ouchi(h(0))
        ~GraphLayout() = default;
